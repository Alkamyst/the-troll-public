COURSE_ACTS(COURSE_BOB, _(" 1 AUTUMN GROVE"),
       _("BREAK THE GOLDEN CHESTNUT")     , _("REEL IN THE RUNNING RABBIT")    , _("FIND 6 RIVERBED RED COINS"),       
       _("OVER THE WALKING WIGGLERS")     , _("GIANT TREE'S SECRET SWITCH")    , _("WING LUIGI OVER THE GROVE"))
