...
const BehaviorScript bhvKoopaShellUnderwater[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_LONG(oFlags, (OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SILHOUETTE | OBJ_FLAG_MOVE_XZ_USING_FVEL)),
    BEGIN_LOOP(),
...
extern void bhv_luigiman_chestnut_init();
extern void bhv_luigiman_chestnut_loop();
const BehaviorScript bhvLuigimanChestnut[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_MOVE_XZ_USING_FVEL | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    ...
    CALL_NATIVE(bhv_luigiman_chestnut_init),
    BEGIN_LOOP(),
...
extern void bhv_moving_platform_slip();
...
extern void bhv_pushing_wall_slip_init();
extern void bhv_pushing_wall_slip_loop();
const BehaviorScript bhvPushingWallSlip1[] = {
    ...
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HOME(),
    CALL_NATIVE(bhv_pushing_wall_slip_init),
    BEGIN_LOOP(),
...
extern void bhv_final_boss_bullet_bill_loop();
const BehaviorScript bhvFinalBossBulletBill[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_MOVE_XZ_USING_FVEL | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    ...
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_final_boss_bullet_bill_loop),
    END_LOOP(),
};

extern void bhv_throw_shell_init();
extern void bhv_throw_shell_loop();
const BehaviorScript bhvThrowShell[] = {
    BEGIN(OBJ_LIST_DESTRUCTIVE),
    OR_INT(oFlags, (OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    DROP_TO_FLOOR(),
    SET_HOME(),
    CALL_NATIVE(bhv_throw_shell_init),
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
...
extern void bhv_instant_bullet_bill_init();
extern void bhv_instant_bullet_bill_loop();
const BehaviorScript bhvInstantBulletBill[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_MOVE_XZ_USING_FVEL | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 50, /*Height*/ 100, /*Downwards offset*/ 100),
    ...
    SET_INT(oIntangibleTimer, 0),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    CALL_NATIVE(bhv_instant_bullet_bill_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_instant_bullet_bill_loop),
    END_LOOP(),
};

extern void bhv_target();
const BehaviorScript bhvTarget[] = {
    ...
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_target),
    END_LOOP(),
};

extern void bhv_target_fall();
const BehaviorScript bhvTargetFall[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    LOAD_COLLISION_DATA(target_collision),
    ...
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_target_fall),
    END_LOOP(),
};

extern void bhv_falling_stage_loop();
const BehaviorScript bhvFallingStage1[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_MOVE_XZ_USING_FVEL | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(falling_stage_1_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_falling_stage_loop),
    END_LOOP(),
};

extern void bhv_falling_stage_loop();
const BehaviorScript bhvFallingStage2[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_MOVE_XZ_USING_FVEL | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(falling_stage_2_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_falling_stage_loop),
...
extern void bhv_rotate_final();
extern const Collision rotate_final_collision[];
const BehaviorScript bhvRotateFinal[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_ANGLE_TO_MOVE_ANGLE  | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(rotate_final_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_rotate_final),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

extern void bhv_cage_lip();
extern const Collision cage_lip_collision[];
const BehaviorScript bhvCageLip[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_ANGLE_TO_MOVE_ANGLE  | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(cage_lip_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_cage_lip),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

extern void bhv_disappear_plat();
extern const Collision disappear_plat_collision[];
const BehaviorScript bhvDisappearPlat[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_ANGLE_TO_MOVE_ANGLE  | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(disappear_plat_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_disappear_plat),
    END_LOOP(),
};

extern void bhv_moving_platform_slip();
extern const Collision final_slip_collision[];
const BehaviorScript bhvFinalSlip[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_ANGLE_TO_MOVE_ANGLE | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(final_slip_collision),
    //LOAD_COLLISION_DATA(luigiman_moving_platform_collision),
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HOME(),
    BEGIN_LOOP(),
...
extern void bhv_target();
const BehaviorScript bhvGrateBreak[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    LOAD_COLLISION_DATA(grate_break_collision),
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_target),
...
extern void bhv_target();
const BehaviorScript bhvSecretCrack[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    LOAD_COLLISION_DATA(secret_crack_collision),
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_target),
...
const BehaviorScript bhvPeachMessage[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, peach_seg5_anims_0501C41C),
    ANIMATE(PEACH_ANIM_0),
...
extern void bhv_collect_fake_star_loop();
const BehaviorScript bhvFakeStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HOME(),
    ...
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_collect_fake_star_loop),
    END_LOOP(),
};
