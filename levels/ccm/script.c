...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_BREAKABLE_BOX, -211, 448, -2281, 0, 90, 0, 0x00000000, bhvHiddenObject),
		OBJECT(MODEL_BREAKABLE_BOX, -722, 545, -2281, 0, 90, 0, (0 << 16), bhvHiddenObject),
		OBJECT(MODEL_BREAKABLE_BOX, -927, 852, -2281, 0, 90, 0, 0x00000000, bhvHiddenObject),
		...
		OBJECT(MODEL_BREAKABLE_BOX, 950, 305, -2281, 0, 90, 0, 0x00000000, bhvHiddenObject),
		...
		OBJECT(MODEL_METAL_BOX, -7, 49, -486, 0, -180, 0, 0x00000000, bhvRedCoinBars),
		OBJECT(MODEL_STAR, -7, 358, -1400, 0, -180, 0, 0x00000000, bhvFakeStar),
		OBJECT(MODEL_THE_TROLL, -440, 49, 44, 0, 51, 0, (9 << 16), bhvTrollInteract),
