...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_METAL_BOX, 1593, 229, 981, 0, 90, 0, 0x00000000, bhvPushableMetalBox),
		OBJECT(MODEL_RED_COIN, -1464, 229, 779, 0, -180, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -1464, 229, 195, 0, -180, 0, 0x00000000, bhvRedCoin),
