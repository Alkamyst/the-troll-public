...
const LevelScript level_troll_test_entry[] = {
	...
	AREA(1, troll_test_area_1),
		...
		OBJECT(MODEL_METAL_BOX, -1020, 100, -12816, 0, 0, 0, 0x00000000, bhvDynamite),
		OBJECT(MODEL_METAL_BOX, -620, 100, -13479, 0, 0, 0, 0x00000000, bhvDynamiteTrail),
		OBJECT(MODEL_METAL_BOX, -1495, 100, -12816, 0, 0, 0, 0x00000000, bhvDynamiteWall),
		OBJECT(MODEL_RED_FLAME, -232, 100, -13321, 0, 0, 0, 0x00000000, bhvFlame),
