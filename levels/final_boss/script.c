...
const LevelScript level_final_boss_entry[] = {
	...
	AREA(1, final_boss_area_1),
		...
		OBJECT(MODEL_METAL_BOX, 28, 100, -37, 0, 0, 0, 0x00000000, bhvFinalBoss),
		OBJECT(MODEL_BULLET_BILL, 28, 100, -37, 0, 0, 0, 0x00000000, bhvFinalBossBulletBill),
		...
		OBJECT(MODEL_KOOPA_SHELL, 1629, 329, -1074, 0, 0, 0, 0x00000000, bhvThrowShell),
		OBJECT(MODEL_KOOPA_SHELL, 2036, 329, -42, 0, 0, 0, 0x00000000, bhvThrowShell),
		OBJECT(MODEL_KOOPA_SHELL, 1294, 329, 1106, 0, 0, 0, 0x00000000, bhvThrowShell),
		OBJECT(MODEL_NONE, 0, 200, -1456, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 200, -1456),
