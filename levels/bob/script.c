...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, 545, 100, -6104, 0, -90, 0, 0x000B0000, bhvWarpPipe),
	...
	AREA(2, bob_area_2),
		...
		OBJECT(MODEL_DL_CANNON_LID, 7093, 778, 4871, 0, -90, 0, (192 << 16), bhvCannonClosed),
		OBJECT(MODEL_CANNON_WALL, 7091, 1462, 8701, 0, 0, 0, 0x00000000, bhvMovingPlatformSlip2),
