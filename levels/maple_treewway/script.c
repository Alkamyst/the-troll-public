...
const LevelScript level_maple_treewway_entry[] = {
	...
	AREA(1, maple_treewway_area_1),
		...
		OBJECT(MODEL_GOLDEN_CHESTNUT, 8101, 3632, -9580, 0, 0, 0, (0 << 24), bhvLuigimanGoldenChestnut),
		...
		OBJECT(MODEL_NONE, 4259, 3289, -7206, 0, -39, 0, (2 << 16), bhvLuigimanLeafPile),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 1804, 1324, -9194, 0, -79, 0, (52 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 3836, 133, -8784, 0, 69, 0, (52 << 16), bhvMessagePanel),
		OBJECT(MODEL_METAL_BOX, 645, 3184, -10236, 0, 0, 0, 0x00000000, bhvPushableMetalBox),
		OBJECT(MODEL_METAL_BOX, 5086, 2086, -8821, 0, 0, 0, 0x00000000, bhvPushableMetalBox),
		...
		OBJECT(MODEL_MAPLE_TREE, 4259, 2666, -7206, 0, -39, 0, (63 << 16), bhvPoleGrabbing),
