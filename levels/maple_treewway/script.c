...
const LevelScript level_maple_treewway_entry[] = {
	...
	AREA(1, maple_treewway_area_1),
		...
		OBJECT(MODEL_CHESTNUT, 1133, 1235, -6717, 0, 0, 0, (0 << 16), bhvLuigimanChestnut),
		OBJECT(MODEL_NONE, 156, 476, -5283, 0, 30, 0, (0 << 16), bhvGoombaTripletSpawner),
		...
		OBJECT(MODEL_MAPLE_TREE, -676, 366, -4301, 0, 175, 0, (63 << 16), bhvPoleGrabbing),
