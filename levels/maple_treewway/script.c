...
const LevelScript level_maple_treewway_entry[] = {
	...
	AREA(1, maple_treewway_area_1),
		...
		OBJECT(MODEL_RED_COIN, 3946, 1830, -9397, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_YELLOW_COIN, 6057, 2185, -10268, 0, -84, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 5838, 2185, -10378, 0, -84, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 5879, 2185, -10115, 0, -84, 0, 0x00000000, bhvYellowCoin),
