...
const LevelScript level_maple_treewway_entry[] = {
	...
	AREA(1, maple_treewway_area_1),
		...
		OBJECT(MODEL_RED_COIN, 3707, 1041, -5025, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 3443, 961, -6674, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_NONE, 3304, 613, -11097, 0, 0, 0, (2 << 16), bhvHiddenRedCoinStar),
