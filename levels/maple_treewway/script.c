...
const LevelScript level_maple_treewway_entry[] = {
	...
	AREA(1, maple_treewway_area_1),
		...
		OBJECT(MODEL_METAL_BOX, 910, 100, -3250, 0, 0, 0, (0 << 16), bhvPushableMetalBox),
		OBJECT(MODEL_MIPS, 2046, 100, -2975, 0, 0, 0, (1 << 24), bhvMips),
		OBJECT(MODEL_NONE, 0, 200, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 200, 0),
		OBJECT(MODEL_WIGGLER_HEAD, 2053, 100, -2, 0, 0, 0, (0 << 16), bhvWigglerHead),
		OBJECT(MODEL_WIGGLER_HEAD, 3821, 477, -1278, 0, 0, 0, (0 << 16), bhvWigglerHead),
