...
DEFINE_LEVEL("TROLL_TEST", LEVEL_TROLL_TEST, COURSE_TROLL_TEST, troll_test, generic, 20000, 0x00, 0x00, 0x00, _, sCamTrollTest) 
DEFINE_LEVEL("FINAL_BOSS", LEVEL_FINAL_BOSS, COURSE_FINAL_BOSS, final_boss, generic, 20000, 0x00, 0x00, 0x00, _, sCamFinalBoss) 
