...
const LevelScript level_castle_courtyard_entry[] = {
	...
	AREA(1, castle_courtyard_area_1),
		...
		OBJECT(MODEL_PEACH, 266, 291, -169, 0, -10, 0, (17 << 24), bhvPeachMessage),
		OBJECT(MODEL_WOODEN_SIGNPOST, 28, 166, -1612, 0, 0, 0, (18 << 16), bhvMessagePanel),
		OBJECT(MODEL_TOAD, -346, 291, 17, 0, 34, 0, (16 << 24), bhvToadMessage),
