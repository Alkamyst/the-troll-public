...
const GeoLayout castle_grounds_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, -404, -6476, 1809, 0, -180, 0, castle_grounds_dl_Luigi_001_mesh_layer_4),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -404, -6476, 1809, 0, -180, 0, castle_grounds_dl_Main_001_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
