...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_NONE, 1287, 224, 174, 0, -90, 0, 0x00000000, bhvSignOnWall),
		OBJECT(MODEL_NONE, -1247, 206, -414, 0, 90, 0, 0x00000000, bhvSignOnWall),
	...
	AREA(2, castle_inside_area_2),
		...
		OBJECT(MODEL_NONE, -1247, 206, -414, 0, 90, 0, 0x00000000, bhvSignOnWall),
		OBJECT(MODEL_NONE, 1287, 224, 174, 0, -90, 0, 0x00000000, bhvSignOnWall),
		OBJECT(MODEL_NONE, -9029, 428, -2691, 0, 0, 0, 0x00000000, bhvSignOnWall),
		OBJECT(MODEL_NONE, -9029, 428, -2891, 0, -180, 0, 0x00000000, bhvSignOnWall),
