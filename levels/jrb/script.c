...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_SHELLDOOR, 1193, 4951, 2800, 0, 90, 0, (2 << 16), bhvKeyDoor),
		OBJECT(MODEL_SHELLDOOR, -926, 5382, 2800, 0, 90, 0, (2 << 16), bhvKeyDoor),
		OBJECT(MODEL_SHELLDOOR, -2788, 5382, -674, 0, 0, 0, (2 << 16), bhvKeyDoor),
		...
		OBJECT(MODEL_BULLET_BILL, 1490, 1404, -4226, 0, 0, 0, 0x00000000, bhvInstantBulletBill),
